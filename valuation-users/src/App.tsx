    ...
    <div className="relative">
      <div className='flex flex-col'>
        <div className='flex flex-col h-screen'>
          ...
          <div className={`z-10 border-t-2 border-b-2 border-r-2 border-[#618ba3] rounded-r-md  bg-gradient-to-b from-[#f0f2f5] via-[#ced6e4d2] to-[#c9d3d8] font-bold w-52 transition-all duration-700 ease-out text-center space-y-8 h-full min-h-20vh ${navbarOpen ? '' : '-ml-52'}`}>
            ...
            <button className={navItemsClass} onClick={() => navigate("/valuations")}><div className='flex flex-row items-center justify-center space-x-2'><p>Valuations</p><span className=' mt-1'><Purch/></span></div></button>
            <button onClick={() => navigate("/getpercentages")} className={navItemsClass}> <div className='flex flex-row items-center justify-center space-x-1'><p>Percentages</p><Percentage/></div></button>
            <button onClick={() => navigate("/casco")} className={navItemsClass}> <div className='flex flex-row items-center justify-center space-x-2'><p>Casco</p><Car/></div></button>
            <button onClick={() => {navigate("/"), setUserLoggedIn(''); }} className={navItemsClass}> <div className='flex flex-row items-center justify-center space-x-2.5'><p>Log out</p><Logout/></div></button>
            </> 
            }
