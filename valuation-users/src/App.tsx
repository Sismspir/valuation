          ...
          {/* This is my vertical navbar */}
            <div className={`z-10 border-t-2 border-b-2 border-r-2 ${isDarkMode ? "text-[#c9d7dc] bg-gradient-to-b from-[#295c6b] via-[#0e1352d2] to-[#f0f2f5]" : "text-[#234352] border-[#618ba3] rounded-r-md  bg-gradient-to-b from-[#f0f2f5] via-[#ced6e4d2] to-[#c9d3d8]"} font-bold w-52 transition-all duration-700 ease-out text-center space-y-8 h-full min-h-20vh ${navbarOpen ? '' : '-ml-52'}`}>
              ...
              <div className={`font-serif text-[1.3rem] mt-6 pb-6 bg-gradient-to border-b-2 ${ isDarkMode ? "border-[#f1f4f6]" : "border-[#23556e]"} italic`}> Hello {userLoggedIn}
                  ...
                  <button onClick={() => navigate("/generali")} className={navItemsClass}> <div className={` ${isDarkMode ? "text-[#c9d7dc]" : ""} flex flex-row items-center justify-center space-x-2`}><p className='text-[1.4rem]'>Generali</p><FiFileText/>
                  </div></button>
                  <button onClick={() => navigate("/choose")} className={navItemsClass}> <div className={` ${isDarkMode ? "text-[#c9d7dc]" : ""} flex flex-row items-center justify-center space-x-2`}><p className='text-[1.4rem]'>ChooseCar</p><MdAddAPhoto />
                  </div></button>
