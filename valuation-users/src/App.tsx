    ...
    <div className="relative">
      <div className='flex flex-col'>
        <div className='flex flex-col h-screen'>
          ...
          <div className={`z-10 border-t-2 border-b-2 border-r-2 border-[#1c4055] rounded-r-md  bg-gradient-to-b from-[#d4dce7] via-[#ced6e4d2] to-[#c9d3d8] font-bold w-32 transition-all duration-700 ease-out text-center space-y-8 h-full ${navbarOpen ? '' : '-ml-32'}`}>
